...
const fortisDungeon = () => {
  ...
  const lp1Image = () => (
    <OutWrapper
      defaultChecked={toggle}
      slot={`53.6758px 14.3824px 111.138px rgba(26, 30, 44, 0.338), inset -20.0389px -5.36942px 20.7458px #606CA1, inset 20.0389px 5.36942px 20.7458px #9FB4FF`}
    >
      <AssetImageWrapper slot={`linear-gradient(179.96deg, #FFCD5E -10.92%, #FD984E 112.7%)`}>LP1</AssetImageWrapper>
    </OutWrapper>
  )
  ...
  return (
    <Wrapper defaultChecked={toggle}>
      ...
      <PoolDetail
        ...
        showMaxButtonInLiquidityForm={true}
